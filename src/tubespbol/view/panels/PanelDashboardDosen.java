...
public class PanelDashboardDosen extends JPanel {
    ...
    public PanelDashboardDosen() {
        ...
        JPanel cardArea = new JPanel(new GridLayout(1, 3, 20, 0));
        ...
        cardArea.add(createCard("Total Permintaan", "4", new Color(193, 220, 230), new Color(68, 130, 152)));
        cardArea.add(createCard("Disetujui", "7", new Color(190, 230, 201), new Color(69, 130, 75)));
